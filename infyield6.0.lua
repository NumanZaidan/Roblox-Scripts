--This is just a Inf yield script but i made some changes
...
addcmd('tpunanchored',{'tpua'},function(args, speaker)
    ...
    for i,v in pairs(players) do
        ...
        if game.Workspace:FindFirstChild("tFShNvW74L9V6bg8QzTnky") then
	        game.Workspace:WaitForChild("tFShNvW74L9V6bg8QzTnky"):Destroy()
		end
		local hint = Instance.new("Part", game.Workspace)
		hint.Name = "tFShNvW74L9V6bg8QzTnky"
		hint.CFrame = game.Players.LocalPlayer.Character.Head.CFrame
		hint.Anchored = true


		local hint1 = Instance.new("Highlight", hint)
		hint1.Name = "Ujc5XyC47xJF2rH6wQkYpK"
